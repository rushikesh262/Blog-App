...
if (isset($_POST['presubmit'])) {
    // echo 'helo';
    $predbtitle = trim($_POST['title']);
    $predbcategories = trim($_POST['categories']);
    $predbpost = trim($_POST['post']);
    $predbauthor = $_SESSION['email'];
    $predbdate = date('Y-m-d H:i:s');
    $valuetitle = $_POST['title'];
    $valuepost = $_POST['post'];
    ...
    <section class="mt-3 container form">
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
            ...
            <div class="container">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-sm-12">
                            ...
                            <input type="text" placeholder="<?php echo $placeholdertitle ?>" name="title" value="<?php echo $valuetitle ?>">
                            <!--  value="<?php
                                            // echo $valuename
                                            ?>" -->
                ...
                <input type="text" class="form-control" name="categories" placeholder="">
            </div> -->
                  ...
                  <textarea class="form-control" name="post" rows="10" placeholder="<?php echo $placrholderpost ?>"></textarea>
               </div> -->
                        <script>
                            tinymce.init({
                                selector: '#mytextarea'
                        ...
                        <div class="col-md-12 col-sm-12">
                            <label for="post"><b>Write post</b></label>
                            <textarea id="mytextarea" class="form-control" name="post" placeholder="<?php echo $placrholderpost; ?>"><?php echo $valuepost?></textarea>
                        </div>
                    </div>
                    <div class="row justify-content-center">
                        <div class="col-md-4 col-sm-4">
                            ...
                            <div class="flex">
                            <button class="button2" type="submit" name="presubmit"> preSubmit</button>
                            <button class="button2" type="button" name="presubmit" data-toggle="modal" data-target="#exampleModal2">preview</button>
                            </div>
                        </div>
                        <!-- Modal -->
                            ...
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Blog Post Preview</h5>
                                        ...
                                        <div class="container">
                                            <article class="row mb-4">
                                                <div class="col-lg-10 mx-auto mb-4">
                                                    <h1 class="h2 mb-3"><?php echo $predbtitle; ?></h1>
                                                    <ul class="list-inline post-meta mb-3">
                                                        <li class="list-inline-item"><i class="ti-user mr-2"></i><a href="profile.php?profile='.$post['author'].'"><?php echo $predbauthor; ?></a>
                                                        </li>
                                                        <li class="list-inline-item">Date : <?php echo $predbdate; ?></li>
                                                        <li class="list-inline-item">Category : <a href="categorieslist.php?categories='.$post['categories'].'" class="ml-1"><?php echo $predbcategories; ?></a>
                                                        </li>
                                                    </ul>
                                                </div>
