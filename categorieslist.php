...
<body>
   ...
   <section class="section">
      ...
      style="height:200px; object-fit: cover;">';
            ...
            // <img loading="lazy" src="images/post/post-.$pic[$i]" class="img-fluid" alt="post-thumb"
            // 	style="height:200px; object-fit: cover;">
            ...
            echo '</div>
					...
					<div class="col-md-8">
						<h3 class="h5"><a class="post-title" href="profile.php?profile='.$post['author'].'">' . $post['title'] . '</a></h3>
         ...
         <ul class="pagination">
            ...
            if ($page_counter == 0) {
               ...
               for ($j = 1; $j < $paginations; $j++) {
                  echo "<li class='page-item'><a class='page-link' href=?start=$j&categories=" . $hrefcat . ">" . $j . "</a></li>";
               }
               ...
               echo "<li class='page-item'><a class='page-link' href=?start=$previous&categories=" . $hrefcat . ">-1</a></li>";
               for ($j = 0; $j < $paginations; $j++) {
                  if ($j == $page_counter) {
                     echo "<li class='page-item'><a class='page-link active bg-primary' href=?start=$j&categories=" . $hrefcat . ">" . $j . "</a></li>";
                  } else {
                     echo "<li class='page-item'><a class='page-link' href=?start=$j&categories=" . $hrefcat . ">" . $j . "</a></li>";
                  }
               }
               if ($j != $page_counter + 1)
                  echo "<li class='page-item'><a class='page-link' href=?start=$next&categories=" . $hrefcat . ">Next<a></li>";
            }
            ?>
         </ul>
      </div>
